...
class SocialLoginController extends Controller
{
    ...
    { 
       ...
       // $password = '1234567';
        ...
        $create_customer = $shop->api()->rest(
         ...
         print_r( $create_customer['status']);
         print_r( $create_customer['body']);
         
         die;


           $phone = '5623458778';
   $customer_data = $shop->api()->rest('GET', '/admin/api/2022-07/customers/search.json', ['query' => "phone:{$phone}"]);
   print_r($customer_data['status']);
   print_r($customer_data['body']['container']['customers']);  
   ...
   die;
     die;
            ...
            $html.='<a  href="#" class="mt-icon cl-twitter mt-social-connect " title="Twitter" onclick="mtSocialLogin(`'.$_GET['shop'].'`,`twitter`)"> <i class="fab fa-twitter"></i>
