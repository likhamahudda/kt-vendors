...
<script src="https://kit.fontawesome.com/8f573b0832.js" crossorigin="anonymous"></script>
...
?>
 ...
 .socaillinks {    
    ...
    <div class="container-fluid">
        ...
        <div class="col-xl-4 col-lg-4 d-sm-flex">
        <h1 class="h3 mb-0 text-gray-800 mt-3 mb-3">Settings</h1>
         
        </div>

        <div class="col-xl-8 col-lg-8 d-sm-flex  socaillinks">
                <ul style=" display: flex; justify-content: end; ">  
                <li><a href="https://sociallogin.developersforhire.site/social-login/how-to-use.html" target="blank" class="">Install instructions</a> </li>
                     <li><a href="https://sociallogin.developersforhire.site/social-login/contact-us.html" target="blank" class="">Contact us</a> </li>
                 </ul>
         </div>
        </div>
        </div>
        ...
        <span class="nav-text">Social Networks</span>
        </a>
        </li>
        <li class="nav-item">
        ...
        <div class="socialsmain py-3">
        <div class="row">
        <div class="tab-content col-md-7 bg-white">
        <div class="tab-pane  show active" id="add_tab-services" role="tabpanel">
        <div class="position-relative row form-group mb-2 eEnableapp">
            <label class="control-label col-md-4 mb-0" for="status">Enable app</label>
            <div class="col-md-8">
        ...
        <div class="col-md-12">
        <ul class="list-social-services" id="socialList">
        <li class="cl-facebook item-social" data-id="facebook" draggable="false">
        <span class="mt-icon icon-facebook"><i class="fab fa-facebook-f"></i></span>
        ...
        <span class="mt-icon icon-google"><i class="fab fa-google"></i></span>
        <label data-toggle="tooltip" data-placement="top" title="" data-original-title="Click to edit social label">
        ...
        <span class="mt-icon icon-linkedin"><i class="fab fa-linkedin-in"></i></span>
        <label data-toggle="tooltip" data-placement="top" title="" data-original-title="Click to edit social label">
        ...
        <span class="mt-icon icon-twitter"><i class="fa-brands fa-github"></i></span>
        <label data-toggle="tooltip" data-placement="top" title="" data-original-title="Click to edit social label">
        <input class="socials-input-label" type="text" name="label[twitter]" value="{{isset($user_data)?$user_data->twitter_label:'Github'}}">
        </label>
        <div class="detail">
        ...
        <div class="tab-pane customize-section" id="add_tab-settings" role="tabpanel">
        <div class="position-relative form-group">
        <label class="control-label " for="status">Button style</label>
        <div class="">
        ...
        <div class="position-relative form-group">
        <label class="control-label" for="status">Button size</label>
        <div class="btn-group-custom" data-toggle="buttons">
        ...
        <div class="position-relative form-group">
        <div class="">
        <label class="control-label" for="position_social">Button position</label>
        <div class="">
        <select class="btn-preview form-control" name="position_social">
        <option value="top" {{isset($user_data) &&$user_data->button_position=='top'?'selected':''}}>Above the Login Form</option>
        <option value="bottom" {{isset($user_data) &&$user_data->button_position=='bottom'?'selected':''}}>Below the Login Form</option>
        </select>
        </div>
        </div>
        </div>
        ...
        <div class="position-relative form-group">
        <div class="">
        <label class="control-label" for="social_heading">Social heading</label>
        <div class="">
